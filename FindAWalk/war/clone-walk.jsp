...
<html>
  <head>
  	...
  	<title>Clone a Walk | Find A Walk</title>
  </head>
  ...
  <body>
	...
	%>
  	...
  	<div class="container">
  		<h1>Clone Your Walk:</h1>
  		<form class="form form-validate" role="form" name="cloneWalk" method="post" action="/createWalk">
			<div class="row">
				<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					%>
					<input type="hidden" name="latitude" id="latitude" value="<%=walk.latitude%>">
					<input type="hidden" name="longitude" id="longitude" value="<%=walk.longitude%>">
					<input type="hidden" name="google_location" id="google_location" value="<%=walk.location%>">
					<button type="submit" class="btn btn-primary" id="createBtn">Create This Walk</button>			
				</div>
			</div>
		</form>
<!-- 		<script>
